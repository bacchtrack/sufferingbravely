...
from cbeancontent.views import LinkDeleteView
from cbeancontent.views import LinkCreateView
from cbeancontent.views import LinkDetailView
from cbeancontent.views import VoteFormView
...
urlpatterns = [
    ...
    path('link/create/', auth(LinkCreateView.as_view()), name='link_create'),
    path('link/update/<pk>/', auth(LinkUpdateView.as_view()), name='link_update'),
    path('link/delete/<pk>/', auth(LinkDeleteView.as_view()), name='link_delete'),
